export const en: Record<string, string> = {
  ...
  "footer.disclaimer": "LoL Build Sim was created under Riot Games' \"Legal Jibber Jabber\" policy using assets owned by Riot Games. Riot Games does not endorse or sponsor this project. League of Legends and Riot Games are trademarks of Riot Games, Inc.",

  // Support page
  "support.title": "Support This Project",
  "support.description": "LoL Build Sim is a free, open tool. If you find it useful, consider buying us a coffee to help cover server costs and development time.",
  ...
  "howToUse.intro": "Here's a guide to using LoL Build Sim.",
  ...
  "privacy.intro": "LoL Build Sim (hereinafter \"this site\") respects user privacy and is committed to protecting personal information. Below is an explanation of how personal information is handled on this site.",
  ...
  "privacy.riotApi.title": "Riot Games API Data Handling",
  "privacy.riotApi.body": "The match history feature on this site retrieves summoner information (PUUID) and match data through the Riot Games API. This data is used solely for processing your request and is temporarily cached on our server for up to 5 minutes. No data is permanently stored in any database. Retrieved data is never shared with or sold to third parties. Our use of the Riot Games API complies with the Riot Games Developer Terms of Service.",
  ...
  "terms.intro": "By using LoL Build Sim (hereinafter \"this site\"), you agree to the following terms of service.",
  "terms.usage.title": "Use of Service",
  "terms.usage.body": "This site is an unofficial tool intended for League of Legends build simulation and match history viewing. Use is free of charge, but service may be temporarily unavailable due to Riot Games API rate limits or server conditions.",
  "terms.riotApi.title": "Riot Games API Usage",
  "terms.riotApi.body": "The match history feature uses the Riot Games API. Game data retrieved through this site is the property of Riot Games, Inc. Users must not redistribute or repurpose data obtained through this site for commercial purposes.",
  "terms.accuracy.title": "Accuracy of Information",
  "terms.accuracy.body": "Damage calculations and stat values displayed on this site may differ from actual in-game values. Discrepancies may arise from patch updates or changes to game mechanics, and this site does not guarantee the accuracy of such information.",
  ...
  "match.searchButton": "Search",
  "match.searching": "Searching...",
  "match.recentMatches": "Recent Matches",
  "match.timeline": "Timeline",
  "match.minute": "min",
  "match.importAlly": "Import as Ally",
  "match.importEnemy": "Import as Enemy",
  "match.win": "Victory",
  "match.loss": "Defeat",
  "match.notFound": "Summoner not found",
  "match.rateLimited": "Rate limited. Please wait and try again.",
  "match.loading": "Loading...",
  "match.loadingMatches": "Fetching match data...",
  "match.loadingTimeline": "Loading timeline...",
  "match.viewTimeline": "View Timeline",
  "match.backToMatches": "Back to Matches",
  "match.blueTeam": "Blue Team",
  "match.redTeam": "Red Team",
  "match.gold": "Gold",
  "match.imported": "Imported successfully",
  "match.level": "Lv",
  "match.disclaimer": "LoL Build Sim isn't endorsed by Riot Games and doesn't reflect the views or opinions of Riot Games or anyone officially involved in producing or managing Riot Games properties.",
  "match.title": "Match History",
  "match.gameNamePlaceholder": "Game Name",
  "match.tagPlaceholder": "Tag",
  "match.searchHint": "Enter Riot ID (e.g. Name#Tag) to look up match history.",
  "match.enterNameTag": "Please enter both game name and tag.",
  "match.searchError": "An error occurred during search. Please try again.",
  "match.noMatches": "No recent matches found.",
  "match.timelineError": "Failed to load timeline data.",
  "match.backToList": "Back to match list",
};
